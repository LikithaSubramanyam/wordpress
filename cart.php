...
?>
<form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post" action="test.php">
	...
	<table style="width:150%" class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
                ...
                <th class="product-length"><?php esc_html_e( 'Length', 'woocommerce' ); ?></th>
		...
		<tbody>
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td>
						<input name="T1" type="text"  class="w3-input w3-border" style="width:50%" value="<?php echo($n1); ?>">
						</td>
						<td>
						<input name="T2" type="text" class="w3-input w3-border" style="width:50%" value="<?php echo($n2); ?>">
						</td>
						<td>
						<input name="T3" type="text" class="w3-input w3-border" style="width:50%" value="<?php echo($n3); ?>">
						</td>
			...
			<tr>
				<td colspan="6" class="actions">
					...
					<button type="submit" name="S1"class="button" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
